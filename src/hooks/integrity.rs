...
pub enum IntegrityStatus {
    ...
    Verified,
    /// Hash mismatch — hook has been modified outside of `obliterate init`
...
/// Run integrity check and print results (for `obliterate verify` subcommand)
...
/// re-run `obliterate init -g --auto-patch` to re-establish the baseline.
