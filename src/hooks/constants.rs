pub const REWRITE_HOOK_FILE: &str = "obliterate-rewrite.sh";
pub const GEMINI_HOOK_FILE: &str = "obliterate-hook-gemini.sh";
...
/// Native Rust hook command for Claude Code (replaces obliterate-rewrite.sh).
pub const CLAUDE_HOOK_COMMAND: &str = "obliterate hook claude";
/// Native Rust hook command for Cursor (replaces obliterate-rewrite.sh).
pub const CURSOR_HOOK_COMMAND: &str = "obliterate hook cursor";
...
pub const LEGACY_CLAUDE_HOOK_COMMAND: &str = "obliterate hook claude";
pub const LEGACY_CURSOR_HOOK_COMMAND: &str = "obliterate hook cursor";

pub const CONFIG_DIR: &str = ".config";
pub const OPENCODE_SUBDIR: &str = "opencode";
pub const PLUGIN_SUBDIR: &str = "plugins";
pub const OPENCODE_PLUGIN_FILE: &str = "obliterate.ts";
...
pub const PI_PLUGIN_FILE: &str = "obliterate.ts";
...
pub const HERMES_PLUGIN_NAME: &str = "obliterate-rewrite";
