...
///
/// Serializable to JSON for export via `obliterate gain --daily --format json`.
///
/// # JSON Schema
///
/// ```json
...
///
/// Serializable to JSON for export via `obliterate gain --weekly --format json`.
...
///
/// Serializable to JSON for export via `obliterate gain --monthly --format json`.
#[derive(Debug, Serialize)]
...
impl Tracker {
    ...
    /// Get parse failure summary for `obliterate gain --failures`.
